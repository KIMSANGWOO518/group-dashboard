...
export default function WeeklyLineChart({ data }: Props) {
  if (data.length === 0)
    return (
      <div className="bg-white rounded-2xl shadow-sm p-6 flex items-center justify-center h-72 text-gray-400">
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-6">
      ...
      <p className="text-xs text-gray-400 mb-4">팀별 주간 작업건수 비교</p>
